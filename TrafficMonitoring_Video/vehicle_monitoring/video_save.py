...
# print(root_dir)
classesFile = root_dir + '/coco.names'
...
modelConfiguration = root_dir + '/yolov4.cfg'
modelWeigheights = root_dir + '/yolov4.weights'
...
def realTime(video_path, dir_root):
    ...
    while cap.isOpened():
        ...
        if success:
            ...
            if writer is None:
                ...
                output_path = dir_root +'/data/'+ PathConfig.OUTPUT_DIR
